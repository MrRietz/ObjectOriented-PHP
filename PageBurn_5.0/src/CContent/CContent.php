...
class CContent {
    ...
    public function insertContent() {
        ...
        if ($this->save) {
            ...
            if ($res) {
                ...
                $output = 'Informationen EJ tillagd.<br><pre>' . print_r($db->Dump(), 1) . '</pre>';
            }
        }
        return $output; 
    }
    ...
    public function renderInsertForm($output) {
        ...
        $html .= "<p><label>Url:<br/><input type='text' name='url' value=''/></label></p>";
        $html .= "<p><label>Text:<br/><textarea name='data'></textarea></label></p>";
        $html .= "<p><label>Type:<br/><input type='text' name='type' value=''/></label></p>";
